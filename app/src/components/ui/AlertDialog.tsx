...
export const AlertDialog = ({
    ...
    return (
        <div className='create-overlay' onClick={onClose} style={{ zIndex: 2200 }}>
            {/* zIndex increased to sit above other modals if necessary */}
            <div
            ...
            >
                ...
                <div className='create-dialog-body' style={{ padding: '20px 24px' }}>
                    <div style={{ fontSize: 14, color: 'var(--text-main)', lineHeight: 1.6, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                        {message}
                    </div>
                </div>
